import { EngineGameState, GameMode, PlayerId, Tile } from './types.ts';
import { generateTileSet, shuffleTiles, tileValue } from './tileUtils.ts';
...
export const initializeGame = (
  ...
  return {
    ...
    player2_score: 0,
    game_mode: gameMode,
    target_score: gameMode === 'fives' ? 150 : 250,
    last_player_id: null,
