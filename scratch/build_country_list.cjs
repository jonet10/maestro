...
console.log("Fetching country list from raw.githubusercontent.com...");
http.get('https://raw.githubusercontent.com/mledoze/countries/master/dist/countries.json', (res) => {
  let data = '';
