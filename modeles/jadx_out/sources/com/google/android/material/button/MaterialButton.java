    ...
    */
    public MaterialButton(@androidx.annotation.NonNull android.content.Context r8, @androidx.annotation.Nullable android.util.AttributeSet r9, int r10) {
        /*
            ...
            goto L8a
        L82:
            com.google.android.material.shape.ShapeAppearanceModel$Builder r0 = com.google.android.material.shape.ShapeAppearanceModel.builder(r0, r1, r3, r4)
    ...
    private void updateIconPosition(int i, int i6) {
        ...
        if (!isIconStart() && !isIconEnd()) {
            if (isIconTop()) {
                ...
                int max = Math.max(0, (((((i6 - getTextHeight()) - getPaddingTop()) - i10) - this.iconPadding) - getPaddingBottom()) / 2);
                if (this.iconTop != max) {
                    this.iconTop = max;
                    updateIcon(false);
                    return;
        ...
        int textLayoutWidth = ((((i - getTextLayoutWidth()) - getPaddingEnd()) - i12) - this.iconPadding) - getPaddingStart();
