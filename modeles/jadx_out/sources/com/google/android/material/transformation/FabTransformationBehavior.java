...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void calculateChildVisibleBoundsAtEndOfExpansion(@NonNull View view, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, @NonNull MotionTiming motionTiming2, float f, float f10, float f11, float f12, @NonNull RectF rectF) {
        float calculateValueOfAnimationAtEndOfExpansion = calculateValueOfAnimationAtEndOfExpansion(fabTransformationSpec, motionTiming, f, f11);
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, float f, float f10, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z9) {
                ...
                animator = CircularRevealCompat.createCircularReveal(circularRevealWidget, calculateRevealCenterX, calculateRevealCenterY, MathUtils.distanceToFurthestCorner(calculateRevealCenterX, calculateRevealCenterY, 0.0f, 0.0f, f, f10));
                ...
                createPostFillRadialExpansion(view2, timing.getDelay(), timing.getDuration(), fabTransformationSpec.timings.getTotalDuration(), i, i6, width, list);
    ...
    private void createPostFillRadialExpansion(View view, long j, long j6, long j10, int i, int i6, float f, @NonNull List<Animator> list) {
        long j11 = j + j6;
        if (j11 < j10) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i, i6, f, f);
