        ...
        if (isDynamicColorAvailable()) {
            ...
            if (dynamicColorsOptions.getPrecondition().shouldApplyDynamicColors(activity, defaultThemeOverlay)) {
                if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
                    ...
                    ColorResourcesOverride resourcesLoaderColorResourcesOverride = (30 > i || i > 33) ? i >= 34 ? ResourcesLoaderColorResourcesOverride.getInstance() : null : ResourcesLoaderColorResourcesOverride.getInstance();
