...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private int getTotalHorizontalOffsetForState() {
        boolean hasBadgeContent = hasBadgeContent();
        BadgeState badgeState = this.state;
        int horizontalOffsetWithText = hasBadgeContent ? badgeState.getHorizontalOffsetWithText() : badgeState.getHorizontalOffsetWithoutText();
        if (this.state.offsetAlignmentMode == 1) {
            boolean hasBadgeContent2 = hasBadgeContent();
            BadgeState badgeState2 = this.state;
            horizontalOffsetWithText += hasBadgeContent2 ? badgeState2.horizontalInsetWithText : badgeState2.horizontalInset;
        }
    ...
    private void onBadgeShapeAppearanceUpdated() {
        ...
        boolean hasBadgeContent = hasBadgeContent();
        BadgeState badgeState = this.state;
        int badgeWithTextShapeAppearanceResId = hasBadgeContent ? badgeState.getBadgeWithTextShapeAppearanceResId() : badgeState.getBadgeShapeAppearanceResId();
        boolean hasBadgeContent2 = hasBadgeContent();
        BadgeState badgeState2 = this.state;
        materialShapeDrawable.setShapeAppearanceModel(ShapeAppearanceModel.builder(context, badgeWithTextShapeAppearanceResId, hasBadgeContent2 ? badgeState2.getBadgeWithTextShapeAppearanceOverlayResId() : badgeState2.getBadgeShapeAppearanceOverlayResId()).build());
        invalidateSelf();
    }
