...
public abstract class NavigationBarItemView extends FrameLayout implements NavigationBarMenuItemView {
    ...
    public static class ActiveIndicatorTransform {
        ...
        public float calculateScaleX(@FloatRange(from = 0.0d, to = 1.0d) float f) {
            return AnimationUtils.lerp(SCALE_X_HIDDEN, 1.0f, f);
        }

        public float calculateScaleY(@FloatRange(from = 0.0d, to = 1.0d) float f) {
            return 1.0f;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setActiveIndicatorProgress(@FloatRange(from = 0.0d, to = 1.0d) float f, float f10) {
    ...
    public void updateActiveIndicatorLayoutParams(int i) {
        if (i > 0 || getVisibility() != 0) {
            ...
            if (this.itemIconGravity == 1) {
                int i10 = i - (this.activeIndicatorExpandedMarginHorizontal * 2);
