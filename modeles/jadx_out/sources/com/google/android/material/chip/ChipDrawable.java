...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i6) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, com.google.android.material.R.styleable.Chip, i, i6, new int[0]);
        ...
        int i10 = obtainStyledAttributes.getInt(com.google.android.material.R.styleable.Chip_android_ellipsize, 0);
        if (i10 == 1) {
    ...
    private boolean onStateChange(@NonNull int[] iArr, @NonNull int[] iArr2) {
        ...
        if (isStateful(this.chipIcon)) {
            z10 |= this.chipIcon.setState(iArr);
        }
        if (isStateful(this.checkedIcon)) {
            z10 |= this.checkedIcon.setState(iArr);
        }
        if (isStateful(this.closeIcon)) {
            int[] iArr3 = new int[iArr.length + iArr2.length];
            System.arraycopy(iArr, 0, iArr3, 0, iArr.length);
            System.arraycopy(iArr2, 0, iArr3, iArr.length, iArr2.length);
            z10 |= this.closeIcon.setState(iArr3);
        }
        if (isStateful(this.closeIconRipple)) {
            z10 |= this.closeIconRipple.setState(iArr2);
        }
        if (z10) {
            invalidateSelf();
        }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (i6 < 255) {
            canvas2 = canvas;
            i = CanvasCompat.saveLayerAlpha(canvas2, bounds.left, bounds.top, bounds.right, bounds.bottom, i6);
        } else {
            canvas2 = canvas;
            i = 0;
        }
