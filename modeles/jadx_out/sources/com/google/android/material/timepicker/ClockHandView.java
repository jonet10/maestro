...
class ClockHandView extends View {
    ...
    private void drawSelector(Canvas canvas) {
        ...
        canvas.drawLine(f, f10, width + ((int) (cos2 * r2)), height + ((int) (r2 * sin2)), this.paint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean handleTouchInput = this.changedDuringTouch | handleTouchInput(x3, y9, z10, z9, z11);
        this.changedDuringTouch = handleTouchInput;
        if (handleTouchInput && z11 && (onActionUpListener = this.onActionUpListener) != null) {
