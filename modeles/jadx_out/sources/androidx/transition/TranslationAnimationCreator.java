...
class TranslationAnimationCreator {
    ...
    public static Animator createAnimation(@NonNull View view, @NonNull TransitionValues transitionValues, int i, int i6, float f, float f10, float f11, float f12, @Nullable TimeInterpolator timeInterpolator, @NonNull Transition transition) {
        ...
        ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(view, PropertyValuesHolder.ofFloat((Property<?, Float>) View.TRANSLATION_X, f, f11), PropertyValuesHolder.ofFloat((Property<?, Float>) View.TRANSLATION_Y, f10, f12));
