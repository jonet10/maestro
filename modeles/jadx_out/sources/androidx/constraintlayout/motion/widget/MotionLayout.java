...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float f, float f10) {
            ...
            canvas.drawText(str, ((min2 / 2.0f) - (this.mBounds.width() / 2)) + min, f10 - 20.0f, this.mTextPaint);
        ...
        private void drawPathScreenTicks(Canvas canvas, float f, float f10, int i, int i6) {
            ...
            String str2 = "" + (((int) ((((f10 - (i6 / 2)) * 100.0f) / (MotionLayout.this.getHeight() - i6)) + 0.5d)) / 100.0f);
            getTextBounds(str2, this.mTextPaint);
                ...
                if (i != 4 || this.mPathMode[i12 - 1] != 0) {
                    ...
                    if (i == 4) {
                        ...
                        if (i15 == 1) {
                            ...
                            drawPathScreenTicks(canvas, f - 0.0f, f10 - 0.0f, i10, i11);
                        }
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> hashMap, int i, int i6) {
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String concat = (constraintWidget.mTop.mTarget != null ? ExifInterface.GPS_DIRECTION_TRUE : "_").concat(constraintWidget.mBottom.mTarget != null ? "B" : "_").concat(constraintWidget.mLeft.mTarget != null ? "L" : "_").concat(constraintWidget.mRight.mTarget != null ? "R" : "_");
                View view2 = (View) constraintWidget.getCompanionWidget();
                String name = Debug.getName(view2);
                if (view2 instanceof TextView) {
                    StringBuilder u9 = x.u(name, "(");
                    u9.append((Object) ((TextView) view2).getText());
                    u9.append(")");
                    name = u9.toString();
                }
                Log.v(MotionLayout.TAG, str2 + "  " + name + " " + constraintWidget + " " + concat);
            }
            Log.v(MotionLayout.TAG, sb.concat(" done. "));
        }
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            String concat3 = concat2.concat(str4);
            ...
            Log.v(MotionLayout.TAG, str + concat3.concat(str6) + " ---  " + constraintWidget);
        }
    ...
    public void setupMotionViews() {
        ...
        if (staggered != 0.0f) {
            ...
            for (int i18 = 0; i18 < childCount; i18++) {
                ...
                if (!Float.isNaN(motionController7.mMotionStagger)) {
                    for (int i19 = 0; i19 < childCount; i19++) {
                        ...
                        if (!Float.isNaN(motionController8.mMotionStagger)) {
                            f10 = Math.min(f10, motionController8.mMotionStagger);
                    ...
                    while (i < childCount) {
                        ...
                        if (!Float.isNaN(motionController9.mMotionStagger)) {
                            ...
                            float f13 = motionController9.mMotionStagger;
                            if (z9) {
                                motionController9.mStaggerOffset = abs - (((f - f13) / (f - f10)) * abs);
                            } else {
                                motionController9.mStaggerOffset = abs - (((f13 - f10) * abs) / (f - f10));
                            }
                        }
                        i++;
                    }
                ...
                float f14 = z9 ? finalY - finalX : finalY + finalX;
            ...
            while (i < childCount) {
                ...
                float f15 = z9 ? finalY2 - finalX2 : finalY2 + finalX2;
                motionController10.mStaggerScale = 1.0f / (1.0f - abs);
                motionController10.mStaggerOffset = abs - (((f15 - f12) * abs) / (f11 - f12));
                i++;
            }
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            StringBuilder t9 = x.t(this.mLastFps + " fps " + Debug.getState(this, this.mBeginState) + " -> ");
            t9.append(Debug.getState(this, this.mEndState));
            t9.append(" (progress: ");
            t9.append(((int) (getProgress() * 1000.0f)) / 10.0f);
            t9.append(" ) state=");
            int i10 = this.mCurrentState;
            t9.append(i10 == -1 ? "undefined" : Debug.getState(this, i10));
    ...
    */
    ...
    public void getViewVelocity(View view, float f, float f10, float[] fArr, int i) {
        ...
        if ((i & 1) == 0) {
            fArr2 = fArr;
            motionController.getPostLayoutDvDp(f11, view.getWidth(), view.getHeight(), f, f10, fArr2);
        } else {
            fArr2 = fArr;
            motionController.getDpDt(f11, f, f10, fArr2);
        }
        if (i < 2) {
            fArr2[0] = fArr2[0] * f12;
            fArr2[1] = fArr2[1] * f12;
    ...
    */
    ...
    public void transitionToState(int i, int i6, int i10, int i11) {
        ...
        MotionScene motionScene = this.mScene;
        if (motionScene != null && (stateSet = motionScene.mStateSet) != null && (convertToConstraintSet = stateSet.convertToConstraintSet(this.mCurrentState, i, i6, i10)) != -1) {
        ...
        if (staggered != 0.0f) {
            ...
            for (int i19 = 0; i19 < childCount; i19++) {
                ...
                motionController5.mStaggerOffset = staggered - ((((finalX + finalY2) - f) * staggered) / (f10 - f));
            }
        }
        this.mTransitionPosition = 0.0f;
        this.mTransitionLastPosition = 0.0f;
    ...
    private void checkStructure(int i, ConstraintSet constraintSet) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (id == -1) {
                StringBuilder v = x.v("CHECK: ", name, " ALL VIEWS SHOULD HAVE ID's ");
                v.append(childAt.getClass().getName());
                v.append(" does not!");
                Log.w(TAG, v.toString());
            }
            if (constraintSet.getConstraint(id) == null) {
                StringBuilder v9 = x.v("CHECK: ", name, " NO CONSTRAINTS for ");
                v9.append(Debug.getName(childAt));
                Log.w(TAG, v9.toString());
            }
        }
