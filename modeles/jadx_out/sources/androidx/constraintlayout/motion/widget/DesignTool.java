...
public class DesignTool {
    ...
    private static void connect(int i, ConstraintSet constraintSet, View view, HashMap<String, String> hashMap, int i6, int i10) {
        String str = sAllAttributes.get(Pair.create(Integer.valueOf(i6), Integer.valueOf(i10)));
        String str2 = hashMap.get(str);
        if (str2 != null) {
            String str3 = sAllMargins.get(str);
            constraintSet.connect(view.getId(), i6, Integer.parseInt(str2), i10, str3 != null ? getPxFromDp(i, hashMap.get(str3)) : 0);
        }
    }
    ...
    private static void setDimensions(int i, ConstraintSet constraintSet, View view, HashMap<String, String> hashMap, int i6) {
        ...
        if (lookUpConstraintId != 0) {
            ...
            if (lookUpConstraintId == startState) {
                ...
                if (lookUpConstraintId == endState) {
                    ...
                    motionLayout3.transitionToState(lookUpConstraintId);
