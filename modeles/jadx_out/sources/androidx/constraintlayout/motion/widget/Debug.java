...
public class Debug {
    public static void dumpLayoutParams(ViewGroup viewGroup, String str) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            StringBuilder u7 = x.u(str2, "     ");
            u7.append(getName(childAt));
    ...
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i6 = 1; i6 <= min; i6++) {
            ...
            String str4 = ".(" + stackTrace[i6].getFileName() + ":" + stackTrace[i6].getLineNumber() + ") " + stackTrace[i6].getMethodName();
            str3 = str3.concat(" ");
