...
public class MotionScene {
            ...
            if (!transition2.mDisable && transition2.mTouchResponse != null) {
                ...
                if (touchRegion == null || motionEvent == null || touchRegion.contains(motionEvent.getX(), motionEvent.getY())) {
                    ...
                    if (limitBoundsTo == null || motionEvent == null || limitBoundsTo.contains(motionEvent.getX(), motionEvent.getY())) {
                        float dot = transition2.mTouchResponse.dot(f, f10);
                        if (transition2.mTouchResponse.mIsRotateMode && motionEvent != null) {
                            dot = ((float) (Math.atan2(f10 + r10, f + r9) - Math.atan2(motionEvent.getX() - transition2.mTouchResponse.mRotateCenterX, motionEvent.getY() - transition2.mTouchResponse.mRotateCenterY))) * 10.0f;
                        }
                        float f12 = dot * (transition2.mConstraintSetEnd == i ? -1.0f : 1.1f);
                        if (f12 > f11) {
    ...
    public ConstraintSet getConstraintSet(int i, int i6, int i10) {
        int stateGetConstraintID;
        StateSet stateSet = this.mStateSet;
        if (stateSet != null && (stateGetConstraintID = stateSet.stateGetConstraintID(i, i6, i10)) != -1) {
    ...
    */
    ...
    public static class Transition {
        ...
        public String debugString(Context context) {
            ...
            StringBuilder u7 = x.u(resourceEntryName, " -> ");
            u7.append(context.getResources().getResourceEntryName(this.mConstraintSetEnd));
            return u7.toString();
        }
