...
public class ConstraintLayout extends ViewGroup {
    ...
    private void init(AttributeSet attributeSet, int i, int i6) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ConstraintLayout_Layout, i, i6);
    ...
    */
    ...
    public boolean dynamicUpdateConstraints(int i, int i6) {
        ...
        while (i10 < size3) {
            ...
            for (int i12 = 0; i12 < size4; i12++) {
                ...
                z9 |= valueModifier.update(size, size2, view.getId(), view, (LayoutParams) view.getLayoutParams());
            }
            i10 = i11;
        }
        return z9;
    ...
    public void onMeasure(int i, int i6) {
        ...
        boolean dynamicUpdateConstraints = this.mDirtyHierarchy | dynamicUpdateConstraints(i, i6);
    ...
    public void resolveMeasuredDimension(int i, int i6, int i10, int i11, boolean z9, boolean z10) {
        ...
        int resolveSizeAndState = View.resolveSizeAndState(i10 + measurer.mPaddingWidth, i, 0);
        int resolveSizeAndState2 = View.resolveSizeAndState(i11 + i12, i6, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i, int i6, int i10) {
        ...
        this.mMeasurer.captureLayoutInfo(i6, i10, max, max2, paddingWidth, i12);
        ...
        if (max3 <= 0 && max4 <= 0) {
            ...
            constraintWidgetContainer.measure(i, mode, i13, mode2, i14, this.mLastMeasureWidth, this.mLastMeasureHeight, i11, max);
        }
        i11 = max3;
        int i132 = size - paddingWidth;
        int i142 = size2 - i12;
        setSelfDimensionBehaviour(constraintWidgetContainer, mode, i132, mode2, i142);
        constraintWidgetContainer.measure(i, mode, i132, mode2, i142, this.mLastMeasureWidth, this.mLastMeasureHeight, i11, max);
    }
    ...
    public void setSelfDimensionBehaviour(ConstraintWidgetContainer constraintWidgetContainer, int i, int i6, int i10, int i11) {
        ...
        if (i == Integer.MIN_VALUE) {
            ...
            i6 = Math.min(this.mMaxWidth - i13, i6);
            dimensionBehaviour = dimensionBehaviour2;
        }
        ...
        if (i6 != constraintWidgetContainer.getWidth() || i11 != constraintWidgetContainer.getHeight()) {
