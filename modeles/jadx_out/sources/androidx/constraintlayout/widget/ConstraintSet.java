...
public class ConstraintSet {
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z9) {
        ...
        populateConstraint(constraint, obtainStyledAttributes, z9);
        obtainStyledAttributes.recycle();
        return constraint;
    }
            ...
            switch (sMapToConstant.get(index)) {
                ...
                case QUANTIZE_MOTION_INTERPOLATOR /* 86 */:
                    ...
                    if (i6 == 1) {
                        ...
                        int indexOf = constraint.motion.mQuantizeInterpolatorString.indexOf("/");
        ...
        switch (i6) {
            case 1:
                if (i11 != 1) {
                    if (i11 != 2) {
                        ...
                        Layout layout = constraint.layout;
                        layout.leftToRight = i10;
                        layout.leftToLeft = -1;
                    }
                } else {
                    Layout layout2 = constraint.layout;
                    layout2.leftToLeft = i10;
            ...
            case 2:
                if (i11 != 1) {
                    if (i11 != 2) {
                        ...
                        Layout layout3 = constraint.layout;
                        layout3.rightToRight = i10;
                        layout3.rightToLeft = -1;
                    }
                } else {
                    Layout layout4 = constraint.layout;
                    layout4.rightToLeft = i10;
            ...
            case 5:
                if (i11 != 5) {
                    ...
                    Layout layout11 = constraint.layout;
                    layout11.baselineToBaseline = i10;
            ...
            case 6:
                if (i11 != 6) {
                    if (i11 != 7) {
                        ...
                        Layout layout12 = constraint.layout;
                        layout12.startToEnd = i10;
                        layout12.startToStart = -1;
                    }
                } else {
                    Layout layout13 = constraint.layout;
                    layout13.startToStart = i10;
            ...
            case 7:
                if (i11 != 7) {
                    if (i11 != 6) {
                        ...
                        Layout layout14 = constraint.layout;
                        layout14.endToStart = i10;
                        layout14.endToEnd = -1;
                    }
                } else {
                    Layout layout15 = constraint.layout;
                    layout15.endToEnd = i10;
        ...
        if (this.mConstraints.containsKey(Integer.valueOf(i))) {
            ...
            if (i6 != -1 || i10 != -1) {
                if (i6 == -1 || i10 == -1) {
                    ...
                    connect(i6, 4, i10, 3, 0);
                    connect(i10, 3, i6, 4, 0);
                }
                clear(i, 3);
                clear(i, 4);
            }
