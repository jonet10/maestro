...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i6, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            Transition.KeyPosition findPreviousPosition = transition.findPreviousPosition(widgetFrame.widget.stringId, i19);
            int i32 = i12;
            Transition.KeyPosition findNextPosition = transition.findNextPosition(widgetFrame.widget.stringId, i19);
            if (findPreviousPosition == findNextPosition) {
                findNextPosition = null;
            }
            if (findPreviousPosition != null) {
                i28 = (int) (findPreviousPosition.mX * i);
                i16 = (int) (findPreviousPosition.mY * i6);
                i17 = findPreviousPosition.mFrame;
            } else {
                i17 = 0;
                i16 = i32;
            }
            if (findNextPosition != null) {
                i14 = (int) (findNextPosition.mX * i);
                i15 = (int) (findNextPosition.mY * i6);
                i18 = findNextPosition.mFrame;
            } else {
                i18 = 100;
                i14 = i30;
                i15 = i31;
    ...
    public void logv(String str) {
        ...
        StringBuilder u7 = x.u(".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName(), " ");
        u7.append(hashCode() % 1000);
        String sb = u7.toString();
        if (this.widget != null) {
            StringBuilder u9 = x.u(sb, "/");
            u9.append(this.widget.hashCode() % 1000);
            concat = u9.toString();
        } else {
            concat = sb.concat("/NULL");
        }
    ...
    public void printCustomAttributes() {
        ...
        if (hashMap != null) {
            for (String str : hashMap.keySet()) {
                ...
                StringBuilder t9 = x.t(concat);
                t9.append(this.mCustom.get(str).toString());
    ...
    public void setCustomAttribute(String str, int i, int i6) {
        ...
        HashMap<String, CustomVariable> hashMap = this.mCustom;
        if (containsKey) {
            hashMap.get(str).setIntValue(i6);
        } else {
            hashMap.put(str, new CustomVariable(str, i, i6));
        }
    }
    ...
    public void setCustomAttribute(String str, int i, boolean z9) {
        ...
        HashMap<String, CustomVariable> hashMap = this.mCustom;
        if (containsKey) {
            hashMap.get(str).setBooleanValue(z9);
        } else {
            hashMap.put(str, new CustomVariable(str, i, z9));
        }
    }
