...
public class Carousel extends MotionHelper {
    ...
    public void updateItems() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int i6 = (this.mIndex + i) - this.mStartIndex;
            if (this.mInfiniteCarousel) {
                if (i6 < 0) {
                    ...
                    int count = i6 % this.mAdapter.count();
                    Adapter adapter2 = this.mAdapter;
                    if (count == 0) {
                        adapter2.populate(view, 0);
                    } else {
                        adapter2.populate(view, (i6 % this.mAdapter.count()) + adapter2.count());
                    }
        ...
        int i13 = this.mIndex;
        int i14 = this.mBackwardTransition;
        if (i13 == 0) {
            enableTransition(i14, false);
        } else {
            enableTransition(i14, true);
            this.mMotionLayout.setTransition(this.mBackwardTransition);
        }
        int i15 = this.mIndex;
        int i16 = count2 - 1;
        int i17 = this.mForwardTransition;
        if (i15 == i16) {
            enableTransition(i17, false);
        } else {
            enableTransition(i17, true);
    ...
    private boolean updateViewVisibility(View view, int i) {
        ...
        for (int i6 : motionLayout.getConstraintSetIds()) {
            z9 |= updateViewVisibility(i6, view, i);
        }
        return z9;
    }
