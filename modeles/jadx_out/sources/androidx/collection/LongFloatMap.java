            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j) < 128) {
                        int i12 = (i << 3) + i11;
                        long j6 = jArr[i12];
                        i6 += Float.floatToIntBits(fArr[i12]) ^ ((int) (j6 ^ (j6 >>> 32)));
                    }
                    j >>= 8;
                }
                if (i10 != 8) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((j & 255) < 128) {
                            ...
                            q9.append((CharSequence) pVar.invoke(Long.valueOf(j6), Float.valueOf(f)));
                            i11++;
                        } else {
                            i6 = i12;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j & 255) < 128) {
                            ...
                            r9.append((CharSequence) pVar.invoke(Long.valueOf(j6), Float.valueOf(f)));
                            i10++;
                        }
                        j >>= 8;
                        i13++;
