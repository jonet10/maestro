                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j & 255) < 128) {
                            ...
                            jArr2 = jArr3;
                            r9.append((CharSequence) pVar.invoke(obj2, Integer.valueOf(i19)));
                            i13++;
                        } else {
                            jArr2 = jArr3;
                            i10 = i15;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j) < 128) {
                        ...
                        i6 += iArr[i12] ^ (obj != null ? obj.hashCode() : 0);
                    }
                    j >>= 8;
                }
                if (i10 != 8) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j & 255) < 128) {
                            ...
                            r9.append((CharSequence) pVar.invoke(obj, Integer.valueOf(i15)));
                            i10++;
                        } else {
                            objArr2 = objArr3;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((j & 255) < 128) {
                            ...
                            q9.append((CharSequence) pVar.invoke(obj, Integer.valueOf(i16)));
                            i11++;
                        } else {
                            i6 = i12;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j & 255) < 128) {
                            ...
                            q9.append((CharSequence) pVar.invoke(obj, Integer.valueOf(i15)));
                            i10++;
                        } else {
                            i = i11;
                        }
