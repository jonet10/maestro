...
public abstract class ObjectLongMap<K> {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            r9.append((CharSequence) pVar.invoke(obj2, Long.valueOf(j6)));
                            i13++;
                        } else {
                            jArr2 = jArr4;
                            i10 = i15;
    ...
    public final long getOrElse(K k5, a aVar) {
        aVar.getClass();
        int findKeyIndex = findKeyIndex(k5);
        return findKeyIndex >= 0 ? this.values[findKeyIndex] : ((Number) aVar.invoke()).longValue();
    }
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((255 & j) < 128) {
                        ...
                        long j6 = jArr[i14];
                        i6 = i10;
                        i11 += ((int) (j6 ^ (j6 >>> 32))) ^ (obj != null ? obj.hashCode() : 0);
                    } else {
                        i6 = i10;
                    }
                    j >>= 8;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((j & 255) < 128) {
                            ...
                            q9.append((CharSequence) pVar.invoke(obj, Long.valueOf(j6)));
                            i11++;
                        } else {
                            i6 = i12;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j & 255) < 128) {
                            ...
                            r9.append((CharSequence) pVar.invoke(obj, Long.valueOf(j6)));
                            i10++;
                        } else {
                            objArr2 = objArr3;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((255 & j) < 128) {
                            ...
                            i = i11;
                            sb.append((CharSequence) pVar.invoke(obj, valueOf));
                            i10++;
                        } else {
                            i = i11;
                        }
