...
public final class MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 extends h implements p {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:17:0x0048 -> B:14:0x008e). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:18:0x004a -> B:6:0x005c). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:8:0x0065 -> B:5:0x0085). Please report as a decompilation issue!!! */
    @Override // v6.a
    /*
