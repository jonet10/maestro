...
public final class RoomTrackingLiveData$invalidated$1 extends i implements p {
    int label;
    final /* synthetic */ RoomTrackingLiveData<T> this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoomTrackingLiveData$invalidated$1(RoomTrackingLiveData<T> roomTrackingLiveData, t6.c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, t6.c cVar) {
        return ((RoomTrackingLiveData$invalidated$1) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
