...
public final class TriggerBasedInvalidationTracker$checkInvalidatedTables$1 extends v6.c {
    Object L$0;
    int label;
    ...
    public TriggerBasedInvalidationTracker$checkInvalidatedTables$1(TriggerBasedInvalidationTracker triggerBasedInvalidationTracker, t6.c cVar) {
        super(cVar);
