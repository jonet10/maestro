...
public final class DBUtil__DBUtil_androidKt$performInTransactionSuspending$3 extends i implements p {
    final /* synthetic */ l $block;
    final /* synthetic */ RoomDatabase $db;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DBUtil__DBUtil_androidKt$performInTransactionSuspending$3(RoomDatabase roomDatabase, l lVar, c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, c cVar) {
        return ((DBUtil__DBUtil_androidKt$performInTransactionSuspending$3) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
