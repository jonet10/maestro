...
public final class InvalidationTracker$addObserver$1 extends i implements p {
    int label;
    final /* synthetic */ InvalidationTracker this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InvalidationTracker$addObserver$1(InvalidationTracker invalidationTracker, t6.c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, t6.c cVar) {
        return ((InvalidationTracker$addObserver$1) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
