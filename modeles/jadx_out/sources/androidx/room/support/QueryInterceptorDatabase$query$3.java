...
public final class QueryInterceptorDatabase$query$3 extends v6.i implements p {
    ...
    public QueryInterceptorDatabase$query$3(QueryInterceptorDatabase queryInterceptorDatabase, SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram, t6.c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, t6.c cVar) {
        return ((QueryInterceptorDatabase$query$3) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
