...
public final class QueryInterceptorDatabase$setTransactionSuccessful$1 extends v6.i implements p {
    int label;
    final /* synthetic */ QueryInterceptorDatabase this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QueryInterceptorDatabase$setTransactionSuccessful$1(QueryInterceptorDatabase queryInterceptorDatabase, t6.c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, t6.c cVar) {
        return ((QueryInterceptorDatabase$setTransactionSuccessful$1) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        queryCallback.onQuery("TRANSACTION SUCCESSFUL", t.f8724a);
        return x.f8463a;
    }
}
