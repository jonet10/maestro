...
public final class QueryInterceptorDatabase$execSQL$2 extends v6.i implements p {
    ...
    public QueryInterceptorDatabase$execSQL$2(QueryInterceptorDatabase queryInterceptorDatabase, String str, List<? extends Object> list, t6.c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, t6.c cVar) {
        return ((QueryInterceptorDatabase$execSQL$2) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
