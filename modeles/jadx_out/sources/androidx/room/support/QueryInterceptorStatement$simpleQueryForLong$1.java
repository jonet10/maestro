...
public final class QueryInterceptorStatement$simpleQueryForLong$1 extends v6.i implements p {
    final /* synthetic */ List<Object> $argsCopy;
    int label;
    final /* synthetic */ QueryInterceptorStatement this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QueryInterceptorStatement$simpleQueryForLong$1(QueryInterceptorStatement queryInterceptorStatement, List<? extends Object> list, t6.c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, t6.c cVar) {
        return ((QueryInterceptorStatement$simpleQueryForLong$1) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
