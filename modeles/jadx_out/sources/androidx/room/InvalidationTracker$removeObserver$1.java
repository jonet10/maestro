...
public final class InvalidationTracker$removeObserver$1 extends i implements p {
    int label;
    final /* synthetic */ InvalidationTracker this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InvalidationTracker$removeObserver$1(InvalidationTracker invalidationTracker, t6.c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, t6.c cVar) {
        return ((InvalidationTracker$removeObserver$1) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            Object syncTriggers$room_runtime_release = triggerBasedInvalidationTracker.syncTriggers$room_runtime_release(this);
            u6.a aVar = u6.a.f10762a;
            if (syncTriggers$room_runtime_release == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
