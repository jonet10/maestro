...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class UpdatableTouchDelegate extends TouchDelegate {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                ...
                if (this.mTargetBounds.contains(x3, y9)) {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int i6 = obtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (i6 != -1) {
            setImeOptions(i6);
        }
        int i10 = obtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_inputType, -1);
        if (i10 != -1) {
            setInputType(i10);
        }
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        ...
        try {
            ...
            Log.w(LOG_TAG, "Search suggestions cursor at row " + i6 + " returned exception.", e10);
            return null;
        }
    }
