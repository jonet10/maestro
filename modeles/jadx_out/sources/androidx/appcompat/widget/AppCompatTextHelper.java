...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i) {
        ...
        if (resourceId != -1) {
            ...
            if (z12 || !obtainStyledAttributes2.hasValue(R.styleable.TextAppearance_textAllCaps)) {
                z9 = false;
                z10 = false;
            } else {
        ...
        if (z12 || !obtainStyledAttributes3.hasValue(R.styleable.TextAppearance_textAllCaps)) {
            z11 = z10;
        } else {
            z9 = obtainStyledAttributes3.getBoolean(R.styleable.TextAppearance_textAllCaps, false);
            z11 = true;
        }
        ...
        if (i10 >= 26 && obtainStyledAttributes3.hasValue(R.styleable.TextAppearance_fontVariationSettings)) {
            str2 = obtainStyledAttributes3.getString(R.styleable.TextAppearance_fontVariationSettings);
        }
        if (i10 >= 28 && obtainStyledAttributes3.hasValue(R.styleable.TextAppearance_android_textSize) && obtainStyledAttributes3.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, -1) == 0) {
        ...
        if (obtainStyledAttributes4.hasValue(R.styleable.AppCompatTextView_lineHeight)) {
            ...
            if (peekValue == null || peekValue.type != 5) {
                ...
                i6 = TypedValueCompat.getUnitFromComplexDimension(peekValue.data);
        ...
        if (f != -1.0f) {
            ...
            if (i6 == -1) {
                ...
                TextViewCompat.setLineHeight(textView4, i6, f);
            }
        }
    }
