...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onLayout(boolean z9, int i, int i6, int i10, int i11) {
        ...
        int paddingRight = isLayoutRtl ? (i10 - i) - getPaddingRight() : getPaddingLeft();
        ...
        if (view2 != null) {
            positionChild(view2, i14, paddingTop, paddingTop2, isLayoutRtl);
        }
        int paddingLeft = isLayoutRtl ? getPaddingLeft() : (i10 - i) - getPaddingRight();
    ...
    public void onMeasure(int i, int i6) {
        ...
        if (view2 != null) {
            ...
            this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i14), View.MeasureSpec.makeMeasureSpec(i12, i10));
        }
