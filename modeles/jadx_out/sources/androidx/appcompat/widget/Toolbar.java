...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        while (i10 < size) {
            ...
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            int i12 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin - i;
            int i13 = ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin - i6;
    ...
    /* JADX WARN: Removed duplicated region for block: B:47:0x028f A[LOOP:0: B:45:0x028b->B:47:0x028f, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:48:0x029c A[EDGE_INSN: B:48:0x029c->B:49:0x029c BREAK  A[LOOP:0: B:45:0x028b->B:47:0x028f], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:52:0x02ab A[LOOP:1: B:50:0x02a7->B:52:0x02ab, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:53:0x02b8 A[EDGE_INSN: B:53:0x02b8->B:54:0x02b8 BREAK  A[LOOP:1: B:50:0x02a7->B:52:0x02ab], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:56:0x02cf  */
    /* JADX WARN: Removed duplicated region for block: B:62:0x02e0 A[LOOP:2: B:60:0x02dc->B:62:0x02e0, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:63:0x02ed A[SYNTHETIC] */
    ...
    */
    ...
    public void onMeasure(int i, int i6) {
        ...
        iArr2[isLayoutRtl ? 1 : 0] = Math.max(0, currentContentInsetStart - i10);
        if (shouldLayout(this.mMenuView)) {
            measureChildConstrained(this.mMenuView, i, max, i6, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            iArr = iArr2;
            max2 += measureChildCollapseMargins(this.mExpandedActionView, i, max2, i6, 0, iArr);
        ...
        if (shouldLayout(this.mLogoView)) {
            max2 += measureChildCollapseMargins(this.mLogoView, i, max2, i6, 0, iArr);
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                max2 += measureChildCollapseMargins(childAt, i, max2, i6, 0, iArr);
                int max3 = Math.max(i11, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i, i19 + i21, i6, i20, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i14 = Math.max(i14, measureChildCollapseMargins(this.mSubtitleTextView, i, i19 + i21, i6, i20 + i16, iArr));
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(getPaddingRight() + getPaddingLeft() + i19 + i14, getSuggestedMinimumWidth()), i, (-16777216) & i15), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(getPaddingBottom() + getPaddingTop() + Math.max(i11, i16), getSuggestedMinimumHeight()), i6, i15 << 16));
    }
    ...
    public void updateBackInvokedCallbackState() {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            boolean z9 = hasExpandedActionView() && findOnBackInvokedDispatcher != null && isAttachedToWindow() && this.mBackInvokedCallbackEnabled;
