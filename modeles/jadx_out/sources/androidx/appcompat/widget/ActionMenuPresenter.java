    ...
    public boolean flagActionItems() {
        ...
        while (i19 < i) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    i6 -= ActionMenuView.measureChildForCells(itemView, i10, i6, makeMeasureSpec, r32);
                } else {
                ...
                boolean z12 = (i17 > 0 || z11) && i13 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i6 > 0);
                boolean z13 = z12;
                i11 = i;
                if (z12) {
                    View itemView2 = actionMenuPresenter.getItemView(menuItemImpl2, null, viewGroup);
                    if (actionMenuPresenter.mStrictWidthLimit) {
                        int measureChildForCells = ActionMenuView.measureChildForCells(itemView2, i10, i6, makeMeasureSpec, 0);
