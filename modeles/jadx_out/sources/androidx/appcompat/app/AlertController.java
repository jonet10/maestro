...
class AlertController {
    ...
    private void setupView() {
        ...
        if (!z11 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(androidx.appcompat.R.id.textSpacerNoButtons)) != null) {
        ...
        if (!z9) {
            ...
            if (view != null) {
                setScrollIndicators(resolvePanel2, view, z10 | (z11 ? 2 : 0), 3);
            }
        }
