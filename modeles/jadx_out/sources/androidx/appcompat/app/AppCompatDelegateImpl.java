...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static class Api26Impl {
        ...
        public static void generateConfigDelta_colorMode(@NonNull Configuration configuration, @NonNull Configuration configuration2, @NonNull Configuration configuration3) {
            ...
            if (i14 != (i6 & 3)) {
                ...
                configuration3.colorMode = i13 | (i6 & 3);
            }
            ...
            if (i15 != (i11 & 12)) {
                ...
                configuration3.colorMode = i12 | (i11 & 12);
            }
        }
    }
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z9) {
            ...
            if (findMenuPanel != null) {
                AppCompatDelegateImpl appCompatDelegateImpl2 = AppCompatDelegateImpl.this;
                if (!z10) {
                    appCompatDelegateImpl2.closePanel(findMenuPanel, z9);
                } else {
    ...
    private boolean applyApplicationSpecificConfig(boolean z9, boolean z10) {
        ...
        if (!z10 && calculateApplicationLocales != null) {
            calculateApplicationLocales = getConfigurationLocales(this.mContext.getResources().getConfiguration());
        }
        boolean updateAppConfiguration = updateAppConfiguration(mapNightMode, calculateApplicationLocales, z9);
    ...
    */
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i, KeyEvent keyEvent, int i6) {
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            z9 = menuBuilder.performShortcut(i, keyEvent, i6);
        }
        if (z9 && (i6 & 1) == 0 && this.mDecorContentParent == null) {
    ...
    */
    ...
    public LocaleListCompat calculateApplicationLocales(@NonNull Context context) {
        ...
        LocaleListCompat combineLocalesIfOverlayExists = i >= 24 ? LocaleOverlayHelper.combineLocalesIfOverlayExists(requestedAppLocales, configurationLocales) : requestedAppLocales.isEmpty() ? LocaleListCompat.getEmptyLocaleList() : LocaleListCompat.forLanguageTags(Api21Impl.toLanguageTag(requestedAppLocales.get(0)));
    ...
    */
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onPreparePanel(int i, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            boolean z9 = actionBarMenuCallback != null && actionBarMenuCallback.onPreparePanel(i);
            if (!z9) {
                z9 = super.onPreparePanel(i, view, menu);
            }
            if (menuBuilder != null) {
