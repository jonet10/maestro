...
public class MenuBuilder implements SupportMenu {
    ...
    */
    ...
    public MenuItem addInternal(int i, int i6, int i10, CharSequence charSequence) {
        ...
        MenuItemImpl createNewMenuItem = createNewMenuItem(i, i6, i10, ordering, charSequence, this.mDefaultShowAsAction);
    ...
    public void removeGroup(int i) {
        ...
        if (findGroupIndex >= 0) {
            ...
            while (true) {
                int i10 = i6 + 1;
                if (i6 >= size || this.mItems.get(findGroupIndex).getGroupId() != i) {
                    break;
                }
