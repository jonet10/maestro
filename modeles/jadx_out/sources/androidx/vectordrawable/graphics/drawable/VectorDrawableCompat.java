...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder u7 = x.u(str, "current group is :");
        u7.append(vGroup.getGroupName());
        u7.append(" rotation is ");
        u7.append(vGroup.mRotate);
        Log.v(LOGTAG, u7.toString());
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                t9.append(pathDataNodeArr[i].mType);
                t9.append(":");
                str = t9.toString();
        ...
        public void printVPath(int i) {
            ...
            StringBuilder u7 = x.u(str, "current path is :");
            u7.append(this.mPathName);
            u7.append(" pathData is ");
            u7.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, u7.toString());
        }
    ...
    public static class VGroup extends VObject {
        ...
        public boolean onStateChanged(int[] iArr) {
            boolean z9 = false;
            for (int i = 0; i < this.mChildren.size(); i++) {
                z9 |= this.mChildren.get(i).onStateChanged(iArr);
            }
            return z9;
        }
