...
public abstract class ActivityResultRegistry {
    ...
    private int generateRandomNumber() {
        g7.a aVar = d.f5373a;
        int nextInt = d.f5373a.a().nextInt(2147418112);
        while (true) {
            int i = nextInt + 65536;
            ...
            g7.a aVar2 = d.f5373a;
            nextInt = d.f5373a.a().nextInt(2147418112);
        }
    }
    ...
    public final void unregister(@NonNull String str) {
        ...
        if (this.mParsedPendingResults.containsKey(str)) {
            StringBuilder v = x.v("Dropping pending result for request ", str, ": ");
            v.append(this.mParsedPendingResults.get(str));
            Log.w(LOG_TAG, v.toString());
            this.mParsedPendingResults.remove(str);
        }
        if (this.mPendingResults.containsKey(str)) {
            StringBuilder v9 = x.v("Dropping pending result for request ", str, ": ");
            v9.append(this.mPendingResults.getParcelable(str));
            Log.w(LOG_TAG, v9.toString());
            this.mPendingResults.remove(str);
        }
        LifecycleContainer lifecycleContainer = this.mKeyToLifecycleContainers.get(str);
        if (lifecycleContainer != null) {
