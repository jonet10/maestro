...
public final class Constraints {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (this.contentUriTriggers.hashCode() + ((i + ((int) (j6 ^ (j6 >>> 32)))) * 31)) * 31;
    ...
    public static final class Builder {
        ...
        public final Constraints build() {
            ...
            long j6;
            if (Build.VERSION.SDK_INT >= 24) {
                set = q6.l.J0(this.contentUriTriggers);
            ...
            return new Constraints(this.requiredNetworkRequest, this.requiredNetworkType, this.requiresCharging, this.requiresDeviceIdle, this.requiresBatteryNotLow, this.requiresStorageNotLow, j, j6, set);
        }
