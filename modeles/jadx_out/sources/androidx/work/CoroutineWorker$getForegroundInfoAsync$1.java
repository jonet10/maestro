...
public final class CoroutineWorker$getForegroundInfoAsync$1 extends i implements p {
    ...
    public CoroutineWorker$getForegroundInfoAsync$1(CoroutineWorker coroutineWorker, t6.c cVar) {
        super(2, cVar);
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        return new CoroutineWorker$getForegroundInfoAsync$1(this.this$0, cVar);
    }

    @Override // d7.p
    public final Object invoke(a0 a0Var, t6.c cVar) {
        return ((CoroutineWorker$getForegroundInfoAsync$1) create(a0Var, cVar)).invokeSuspend(x.f8463a);
    }
