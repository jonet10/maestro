...
public final class PreferencesSerializer implements OkioSerializer<Preferences> {
    ...
    public Object readFrom(j jVar, c cVar) throws IOException, CorruptionException {
        PreferencesProto.PreferenceMap readFrom = PreferencesMapCompat.Companion.readFrom(jVar.x());
    ...
    @Override // androidx.datastore.core.okio.OkioSerializer
    public Object writeTo(Preferences preferences, i iVar, c cVar) throws IOException, CorruptionException {
        ...
        newBuilder.build().writeTo(iVar.v());
        return x.f8463a;
    }
