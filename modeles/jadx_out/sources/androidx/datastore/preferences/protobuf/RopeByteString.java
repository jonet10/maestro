...
final class RopeByteString extends ByteString {
    ...
    private boolean equalsFragments(ByteString byteString) {
        ...
        while (true) {
            ...
            if (!(i == 0 ? next.equalsRange(next2, i6, min) : next2.equalsRange(next, i, min))) {
                return false;
            }
            i10 += min;
    ...
    public ByteString substring(int i, int i6) {
        int checkRange = ByteString.checkRange(i, i6, this.totalLength);
        if (checkRange == 0) {
    ...
    public class RopeInputStream extends InputStream {
        ...
        public int read(byte[] bArr, int i, int i6) {
            ...
            int readSkipInternal = readSkipInternal(bArr, i, i6);
