...
public final class DataStoreImpl$readAndInitOrPropagateAndThrowFailure$1 extends c {
    int I$0;
    Object L$0;
    int label;
    ...
    public DataStoreImpl$readAndInitOrPropagateAndThrowFailure$1(DataStoreImpl<T> dataStoreImpl, t6.c cVar) {
        super(cVar);
