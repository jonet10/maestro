...
public final class MultiProcessDataStoreFactory {
    ...
    public final <T> DataStore<T> create(Serializer<T> serializer, ReplaceFileCorruptionHandler<T> replaceFileCorruptionHandler, List<? extends DataMigration<T>> list, a0 a0Var, d7.a aVar) {
        ...
        a0Var.getClass();
        aVar.getClass();
        FileStorage fileStorage = new FileStorage(serializer, new MultiProcessDataStoreFactory$create$1(a0Var), aVar);
        List H = a.a.H(DataMigrationInitializer.Companion.getInitializer(list));
        if (replaceFileCorruptionHandler == null) {
            replaceFileCorruptionHandler = (ReplaceFileCorruptionHandler<T>) new NoOpCorruptionHandler();
        }
        return new DataStoreImpl(fileStorage, H, replaceFileCorruptionHandler, a0Var);
    }
    ...
    public final <T> DataStore<T> create(Storage<T> storage, ReplaceFileCorruptionHandler<T> replaceFileCorruptionHandler, List<? extends DataMigration<T>> list, a0 a0Var) {
        ...
        return new DataStoreImpl(storage, H, replaceFileCorruptionHandler, a0Var);
    }
