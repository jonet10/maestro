...
public final class SingleProcessCoordinator$tryLock$1<T> extends c {
    Object L$0;
    boolean Z$0;
    int label;
    ...
    public SingleProcessCoordinator$tryLock$1(SingleProcessCoordinator singleProcessCoordinator, t6.c cVar) {
        super(cVar);
