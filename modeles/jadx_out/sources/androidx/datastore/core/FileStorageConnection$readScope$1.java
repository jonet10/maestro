...
public final class FileStorageConnection$readScope$1<R> extends c {
    Object L$0;
    Object L$1;
    boolean Z$0;
    int label;
    ...
    public FileStorageConnection$readScope$1(FileStorageConnection<T> fileStorageConnection, t6.c cVar) {
        super(cVar);
