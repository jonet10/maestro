    ...
    public void updateTextPositions(int i, float f, boolean z9) {
        ...
        if (i21 == 16) {
            ...
            if (i21 != 80) {
                ...
                textView2.layout(min, i10, min + measuredWidth, textView2.getMeasuredHeight() + i10);
        ...
        textView22.layout(min2, i10, min2 + measuredWidth, textView22.getMeasuredHeight() + i10);
