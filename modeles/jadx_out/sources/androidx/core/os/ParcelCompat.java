    ...
    public static <T> T[] readParcelableArray(@NonNull Parcel parcel, @Nullable ClassLoader classLoader, @NonNull Class<T> cls) {
        ...
        for (int i = 0; i < tArr.length; i++) {
            try {
                ...
                StringBuilder p10 = x.p(i, "Parcelable at index ", " is not a subclass of required class ");
                p10.append(cls.getName());
                p10.append(" provided in the parameter");
                throw new BadParcelableException(p10.toString());
            }
        }
        return tArr2;
    }
