...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(@NonNull Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel d10 = a3.b.d(it.next());
                if (!collection.contains(Api26Impl.getId(d10)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(d10)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(d10));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(@NonNull String str) {
        ...
        if (i >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup e10 = a3.b.e(it.next());
                if (Api26Impl.getId(e10).equals(str)) {
                    return e10;
                }
            }
        }
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(e10));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(e10, notificationChannels));
                    }
                }
                return arrayList;
            }
