...
public class NotificationCompat {
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (Api23Impl.getIcon(action) != null || (i = action.icon) == 0) {
            return new Action(Api23Impl.getIcon(action) != null ? IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action)) : null, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z9, semanticAction, z10, isContextual, isAuthenticationRequired);
        }
        return new Action(i, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z9, semanticAction, z10, isContextual, isAuthenticationRequired);
    }
    ...
    public static class Builder {
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            Notification build = notificationCompatBuilder.build();
            return Build.VERSION.SDK_INT >= 24 ? Api24Impl.createHeadsUpContentView(Api24Impl.recoverBuilder(this.mContext, build)) : build.headsUpContentView;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                ...
                Notification.MessagingStyle createMessagingStyle = i >= 28 ? Api28Impl.createMessagingStyle(person.toAndroidPerson()) : Api24Impl.createMessagingStyle(person.getName());
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                Message message = this.mMessages.get(size);
                CharSequence makeMessageLine = z9 ? makeMessageLine(message) : message.getText();
    ...
    public static abstract class Style {
        ...
        private Bitmap createIconWithBackground(int i, int i6, int i10, int i11) {
            ...
            Bitmap createColoredBitmap = createColoredBitmap(i12, i11, i6);
