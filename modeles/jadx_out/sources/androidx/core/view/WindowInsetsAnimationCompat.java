        ...
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f, int i) {
            ...
            for (int i6 = 1; i6 <= 256; i6 <<= 1) {
                if ((i & i6) == 0) {
                    ...
                    float f10 = 1.0f - f;
                    builder.setInsets(i6, WindowInsetsCompat.insetInsets(insets, (int) (((insets.left - insets2.left) * f10) + 0.5d), (int) (((insets.top - insets2.top) * f10) + 0.5d), (int) (((insets.right - insets2.right) * f10) + 0.5d), (int) (((insets.bottom - insets2.bottom) * f10) + 0.5d)));
                }
            }
