...
public class WindowInsetsCompat {
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i, int i6, int i10, int i11) {
        ...
        return (max == i && max2 == i6 && max3 == i10 && max4 == i11) ? insets : Insets.of(max, max2, max3, max4);
    }
    ...
    public static class Impl20 extends Impl {
        ...
        private Insets getInsets(int i, boolean z9) {
            ...
            for (int i6 = 1; i6 <= 256; i6 <<= 1) {
                if ((i & i6) != 0) {
                    insets = Insets.max(insets, getInsetsForType(i6, z9));
                }
            }
            return insets;
        }
    ...
    @NonNull
    public WindowInsetsCompat inset(@IntRange(from = 0) int i, @IntRange(from = 0) int i6, @IntRange(from = 0) int i10, @IntRange(from = 0) int i11) {
