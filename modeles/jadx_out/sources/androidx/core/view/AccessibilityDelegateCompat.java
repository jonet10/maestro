...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(@NonNull View view, int i, @Nullable Bundle bundle) {
        ...
        if (!z9) {
            z9 = this.mOriginalDelegate.performAccessibilityAction(view, i, bundle);
        }
        return (z9 || i != R.id.accessibility_action_clickable_span || bundle == null) ? z9 : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
