...
public final class ColorStateListInflaterCompat {
    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                float f10 = (Build.VERSION.SDK_INT < 31 || !obtainAttributes.hasValue(R.styleable.ColorStateListItem_android_lStar)) ? obtainAttributes.getFloat(R.styleable.ColorStateListItem_lStar, -1.0f) : obtainAttributes.getFloat(R.styleable.ColorStateListItem_android_lStar, -1.0f);
                ...
                iArr2 = GrowingArrayUtils.append(iArr2, i6, modulateColorAlpha(color, f, f10));
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i, @FloatRange(from = 0.0d, to = 1.0d) float f, @FloatRange(from = 0.0d, to = 100.0d) float f10) {
        ...
        if (z9) {
            ...
            i = CamColor.toColor(fromColor.getHue(), fromColor.getChroma(), f10);
        }
