...
public class ShortcutManagerCompat {
    ...
    public static Intent createShortcutResultIntent(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        Intent createShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? a.b(context.getSystemService(a.e())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int i) {
        ...
        ShortcutManager b7 = a.b(context.getSystemService(a.e()));
        ArrayList arrayList = new ArrayList();
        if ((i & 1) != 0) {
            arrayList.addAll(b7.getManifestShortcuts());
        }
        if ((i & 2) != 0) {
            arrayList.addAll(b7.getDynamicShortcuts());
        }
        if ((i & 4) != 0) {
            arrayList.addAll(b7.getPinnedShortcuts());
        }
    ...
    public static boolean pushDynamicShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (i >= 30) {
            ...
            ShortcutManager b7 = a.b(context.getSystemService(a.e()));
            if (b7.isRateLimitingActive()) {
                return false;
            }
            List<ShortcutInfo> dynamicShortcuts = b7.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                b7.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            b7.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
