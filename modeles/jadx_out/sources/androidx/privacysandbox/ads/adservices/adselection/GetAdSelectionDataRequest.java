...
public final class GetAdSelectionDataRequest {
    ...
    public static final class Ext10Impl {
        ...
        public static final class Companion {
            ...
            public final android.adservices.adselection.GetAdSelectionDataRequest convertGetAdSelectionDataRequest(GetAdSelectionDataRequest getAdSelectionDataRequest) {
                ...
                android.adservices.adselection.GetAdSelectionDataRequest build = new GetAdSelectionDataRequest.Builder().setSeller(getAdSelectionDataRequest.getSeller().convertToAdServices$ads_adservices_release()).build();
                build.getClass();
                return build;
            }
    ...
    public static final class Ext12Impl {
        ...
        public static final class Companion {
            ...
            public final android.adservices.adselection.GetAdSelectionDataRequest convertGetAdSelectionDataRequest(GetAdSelectionDataRequest getAdSelectionDataRequest) {
                getAdSelectionDataRequest.getClass();
                android.adservices.adselection.GetAdSelectionDataRequest build = new GetAdSelectionDataRequest.Builder().setSeller(getAdSelectionDataRequest.getSeller().convertToAdServices$ads_adservices_release()).setCoordinatorOriginUri(getAdSelectionDataRequest.getCoordinatorOriginUri()).build();
                build.getClass();
                return build;
            }
