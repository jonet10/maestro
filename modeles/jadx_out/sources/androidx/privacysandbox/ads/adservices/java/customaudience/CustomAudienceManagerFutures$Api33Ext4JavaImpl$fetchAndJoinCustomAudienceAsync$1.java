...
public final class CustomAudienceManagerFutures$Api33Ext4JavaImpl$fetchAndJoinCustomAudienceAsync$1 extends i implements p {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            Object fetchAndJoinCustomAudience = customAudienceManager.fetchAndJoinCustomAudience(fetchAndJoinCustomAudienceRequest, this);
            u6.a aVar = u6.a.f10762a;
            if (fetchAndJoinCustomAudience == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
