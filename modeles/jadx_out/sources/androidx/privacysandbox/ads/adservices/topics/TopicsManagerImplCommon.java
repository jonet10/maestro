...
public class TopicsManagerImplCommon extends TopicsManager {
    ...
    */
    ...
    public final Object getTopicsAsyncInternal(android.adservices.topics.GetTopicsRequest getTopicsRequest, c cVar) {
    ...
    @RequiresPermission("android.permission.ACCESS_ADSERVICES_TOPICS")
    @DoNotInline
    public Object getTopics(GetTopicsRequest getTopicsRequest, c cVar) {
