...
public class PlaybackSupportFragment extends Fragment {
    ...
    private void loadControlRowAnimator() {
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.leanback.app.PlaybackSupportFragment.8
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                view.setTranslationY((1.0f - floatValue) * PlaybackSupportFragment.this.mAnimationTranslateY);
            }
        };
        Context context = getContext();
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (PlaybackSupportFragment.this.getVerticalGridView().getChildAdapterPosition(childAt) > 0) {
                        ...
                        childAt.setTranslationY((1.0f - floatValue) * PlaybackSupportFragment.this.mAnimationTranslateY);
                    }
                }
            }
        };
    ...
    public boolean onInterceptInputEvent(InputEvent inputEvent) {
        ...
        if (inputEvent instanceof KeyEvent) {
            ...
            z9 = onKeyListener != null ? onKeyListener.onKey(getView(), i, keyEvent) : false;
        } else {
            z9 = false;
            i = 0;
            i6 = 0;
        ...
        if (i != 4 && i != 111) {
            switch (i) {
                ...
                case 23:
                    ...
                    if (this.mShowOrHideControlsOverlayOnUserInteraction && i6 == 0) {
                        tickle();
                    }
                    return z9;
                default:
                    if (this.mShowOrHideControlsOverlayOnUserInteraction && z9 && i6 == 0) {
                        tickle();
                        return z9;
                    }
                    break;
            ...
            if (this.mShowOrHideControlsOverlayOnUserInteraction && z10) {
