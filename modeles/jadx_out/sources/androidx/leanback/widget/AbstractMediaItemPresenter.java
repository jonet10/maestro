...
public abstract class AbstractMediaItemPresenter extends RowPresenter {
    ...
    public static class ViewHolder extends RowPresenter.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            this.mMediaItemNumberView = (TextView) inflate.findViewById(androidx.leanback.R.id.initial);
            this.mMediaItemPausedView = inflate.findViewById(androidx.leanback.R.id.paused);
            this.mMediaItemPlayingView = inflate.findViewById(androidx.leanback.R.id.playing);
        }
    ...
    public static ValueAnimator updateSelector(final View view, View view2, ValueAnimator valueAnimator, boolean z9) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.leanback.widget.AbstractMediaItemPresenter.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator3) {
                ...
                marginLayoutParams.width = Math.round((f * animatedFraction) + width);
                view.requestLayout();
            }
        });
        ofFloat.start();
