...
public class DatePicker extends Picker {
    ...
    public void setDate(int i, int i6, int i10, boolean z9) {
        if (isNewDate(i, i6, i10)) {
            ...
            boolean before = this.mCurrentDate.before(this.mMinDate);
    ...
    public void setDatePickerFormat(String str) {
        ...
        if (extractSeparators.size() != str.length() + 1) {
            a.i("Separators size: ", extractSeparators.size(), " must equal the size of datePickerFormat: ", str.length(), " + 1");
            return;
        }
    ...
    public void updateSpinnersImpl(boolean z9) {
        ...
        for (int length = DATE_FIELDS.length - 1; length >= 0; length--) {
            ...
            if (i >= 0) {
                ...
                boolean updateMin = (z10 ? updateMin(columnAt, this.mMinDate.get(i6)) : updateMin(columnAt, this.mCurrentDate.getActualMinimum(i6))) | (z11 ? updateMax(columnAt, this.mMaxDate.get(i6)) : updateMax(columnAt, this.mCurrentDate.getActualMaximum(i6)));
