...
public class SearchOrbView extends FrameLayout implements View.OnClickListener {
    ...
    public SearchOrbView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSearchOrbView = inflate.findViewById(androidx.leanback.R.id.search_orb);
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, androidx.leanback.R.styleable.lbSearchOrbView, attributeSet, obtainStyledAttributes, i, 0);
