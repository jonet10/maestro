...
public class TitleView extends FrameLayout implements TitleViewAdapter.Provider {
    ...
    public TitleView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBadgeView = (ImageView) inflate.findViewById(androidx.leanback.R.id.title_badge);
        this.mTextView = (TextView) inflate.findViewById(androidx.leanback.R.id.title_text);
        this.mSearchOrbView = (SearchOrbView) inflate.findViewById(androidx.leanback.R.id.title_orb);
