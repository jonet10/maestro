...
public class GuidedActionsStylist implements FragmentAnimationProvider {
    ...
    public void collapseAction(boolean z9) {
        ...
        if (this.mExpandedAction.hasEditableActivatorView()) {
            setEditingMode((ViewHolder) getActionsGridView().findViewHolderForPosition(indexOf), false, z10);
        } else {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, GuidedAction guidedAction) {
        ...
        if (textView != null) {
            ...
            if (i >= 28) {
                boolean isEditable = guidedAction.isEditable();
        ...
        if (textView3 != null) {
            ...
            if (i6 >= 28) {
                boolean isDescriptionEditable = guidedAction.isDescriptionEditable();
        ...
        boolean hasMultilineDescription = guidedAction.hasMultilineDescription();
        ...
        boolean isFocusable = guidedAction.isFocusable();
        View view = viewHolder.itemView;
        if (isFocusable) {
