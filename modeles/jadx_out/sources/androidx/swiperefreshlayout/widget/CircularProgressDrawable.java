...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        ...
        ring.setRotation(x.f(floor, ring.getStartingRotation(), f, ring.getStartingRotation()));
    }
    ...
    public void applyTransformation(float f, Ring ring, boolean z9) {
        ...
        if (f != 1.0f || z9) {
            ...
            if (f < 0.5f) {
                ...
                f10 = startingStartTrim;
            }
            float f11 = (RING_ROTATION * f) + startingRotation;
            float f12 = (f + this.mRotationCount) * GROUP_FULL_ROTATION;
