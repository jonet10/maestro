...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler, RecyclerView.State state, int i, int i6) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (!viewHolder.isRemoved()) {
                ...
                OrientationHelper orientationHelper = this.mOrientationHelper;
                if (z9 != z10) {
                    i10 += orientationHelper.getDecoratedMeasurement(viewHolder.itemView);
                } else {
                    i11 += orientationHelper.getDecoratedMeasurement(viewHolder.itemView);
                }
            }
        }
        ...
        if (!state.isPreLayout() && (i = this.mPendingScrollPosition) != -1) {
            if (i >= 0 && i < state.getItemCount()) {
                ...
                if (findViewByPosition == null) {
                    ...
                    if (orientationHelper3.getEndAfterPadding() - this.mOrientationHelper.getDecoratedEnd(findViewByPosition) < 0) {
                    ...
                    anchorInfo.mCoordinate = z11 ? this.mOrientationHelper.getTotalSpaceChange() + orientationHelper4.getDecoratedEnd(findViewByPosition) : orientationHelper4.getDecoratedStart(findViewByPosition);
                }
                return true;
            }
            this.mPendingScrollPosition = -1;
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (list == null) {
            if (z9 == (layoutState.mLayoutDirection == -1)) {
                addView(next);
            } else {
                addView(next, 0);
            }
        ...
        if (this.mOrientation == 1) {
            if (isLayoutRTL()) {
                ...
                i10 = decoratedMeasurementInOther - this.mOrientationHelper.getDecoratedMeasurementInOther(next);
            } else {
                i10 = getPaddingLeft();
                decoratedMeasurementInOther = this.mOrientationHelper.getDecoratedMeasurementInOther(next) + i10;
            }
            int i12 = layoutState.mLayoutDirection;
            int i13 = layoutState.mOffset;
            if (i12 != -1) {
                i6 = decoratedMeasurementInOther;
                i = layoutChunkResult.mConsumed + i13;
                linearLayoutManager = this;
                i11 = i13;
                linearLayoutManager.layoutDecoratedWithMargins(next, i10, i11, i6, i);
                if (!layoutParams.isItemRemoved() || layoutParams.isItemChanged()) {
                    layoutChunkResult.mIgnoreConsumed = true;
                }
                layoutChunkResult.mFocusable = next.hasFocusable();
            }
            i11 = i13 - layoutChunkResult.mConsumed;
            i = i13;
            i6 = decoratedMeasurementInOther;
        } else {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (state.isPreLayout() && (i12 = this.mPendingScrollPosition) != -1 && this.mPendingScrollPositionOffset != Integer.MIN_VALUE && (findViewByPosition = findViewByPosition(i12)) != null) {
            ...
            OrientationHelper orientationHelper = this.mOrientationHelper;
            if (z9) {
                i13 = orientationHelper.getEndAfterPadding() - this.mOrientationHelper.getDecoratedEnd(findViewByPosition);
        ...
        if (anchorInfo4.mLayoutFromEnd) {
            ...
            if (i18 > 0) {
                updateLayoutStateToFillStart(i16, i6);
                LayoutState layoutState6 = this.mLayoutState;
