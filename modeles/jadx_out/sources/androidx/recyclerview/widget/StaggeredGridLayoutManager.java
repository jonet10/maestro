...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
        ...
        if (i > 0) {
            if (i == this.mSpanCount) {
                for (int i6 = 0; i6 < this.mSpanCount; i6++) {
                    ...
                    int i10 = savedState2.mSpanOffsets[i6];
                    if (i10 != Integer.MIN_VALUE) {
                        boolean z9 = savedState2.mAnchorLayoutFromEnd;
                        OrientationHelper orientationHelper = this.mPrimaryOrientation;
                        i10 += z9 ? orientationHelper.getEndAfterPadding() : orientationHelper.getStartAfterPadding();
                    }
                    this.mSpans[i6].setLine(i10);
                }
            } else {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (staggeredGridLayoutManager3.mLayoutState.mInfinite || !staggeredGridLayoutManager3.mRemainingSpans.isEmpty())) {
            ...
            if (i6 == 1) {
                decoratedMeasurement = z12 ? staggeredGridLayoutManager3.getMaxEnd(endAfterPadding) : span3.getEndLine(endAfterPadding);
                ...
                minStart = z12 ? staggeredGridLayoutManager3.getMinStart(endAfterPadding) : span3.getStartLine(endAfterPadding);
            ...
            if (staggeredGridLayoutManager3.isLayoutRTL() && staggeredGridLayoutManager3.mOrientation == 1) {
                ...
                decoratedMeasurement2 = z13 ? orientationHelper2.getEndAfterPadding() : orientationHelper2.getEndAfterPadding() - (((staggeredGridLayoutManager3.mSpanCount - 1) - span3.mIndex) * staggeredGridLayoutManager3.mSizePerSpan);
            ...
            if (staggeredGridLayoutManager3.mOrientation == 1) {
                staggeredGridLayoutManager3.layoutDecoratedWithMargins(next, i11, decoratedMeasurement, i10, minStart);
                staggeredGridLayoutManager = this;
            } else {
                staggeredGridLayoutManager3.layoutDecoratedWithMargins(next, decoratedMeasurement, i11, minStart, i10);
            ...
            if (z14) {
                ...
                staggeredGridLayoutManager.updateRemainingSpans(span3, layoutState2.mLayoutDirection, i);
            }
    ...
    */
    ...
    private void recycle(RecyclerView.Recycler recycler, LayoutState layoutState) {
        ...
        if (i6 != -1) {
            ...
            if (minEnd >= 0) {
                i10 += Math.min(minEnd, layoutState.mAvailable);
            }
        ...
        int i12 = layoutState.mEndLine;
        if (maxStart >= 0) {
            i12 -= Math.min(maxStart, layoutState.mAvailable);
        }
    ...
    private void updateLayoutState(int i, RecyclerView.State state) {
        ...
        if (!isSmoothScrolling() || (targetScrollPosition = state.getTargetScrollPosition()) == -1) {
            ...
            OrientationHelper orientationHelper = this.mPrimaryOrientation;
            if (z10 == z11) {
                i6 = orientationHelper.getTotalSpace();
                i10 = 0;
            } else {
                i10 = orientationHelper.getTotalSpace();
                i6 = 0;
            }
        }
        ...
        if (clipToPadding) {
            layoutState2.mStartLine = this.mPrimaryOrientation.getStartAfterPadding() - i10;
            this.mLayoutState.mEndLine = this.mPrimaryOrientation.getEndAfterPadding() + i6;
        } else {
            layoutState2.mEndLine = this.mPrimaryOrientation.getEnd() + i6;
    ...
    */
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (!z9 && (focusableViewAfter = span.getFocusableViewAfter(lastChildPosition, convertFocusDirectionToLayoutDirection)) != null && focusableViewAfter != findContainingItemView) {
            return focusableViewAfter;
        }
        if (preferLastSpan(convertFocusDirectionToLayoutDirection)) {
            for (int i6 = this.mSpanCount - 1; i6 >= 0; i6--) {
                View focusableViewAfter2 = this.mSpans[i6].getFocusableViewAfter(lastChildPosition, convertFocusDirectionToLayoutDirection);
        ...
        if (!z9) {
            View findViewByPosition = findViewByPosition(z10 ? span.findFirstPartiallyVisibleItemPosition() : span.findLastPartiallyVisibleItemPosition());
        ...
        if (preferLastSpan(convertFocusDirectionToLayoutDirection)) {
            for (int i11 = this.mSpanCount - 1; i11 >= 0; i11--) {
                if (i11 != span.mIndex) {
                    ...
                    View findViewByPosition2 = findViewByPosition(z10 ? spanArr[i11].findFirstPartiallyVisibleItemPosition() : spanArr[i11].findLastPartiallyVisibleItemPosition());
            ...
            for (int i12 = 0; i12 < this.mSpanCount; i12++) {
                ...
                View findViewByPosition3 = findViewByPosition(z10 ? spanArr2[i12].findFirstPartiallyVisibleItemPosition() : spanArr2[i12].findLastPartiallyVisibleItemPosition());
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i, int i6, boolean z9) {
        ...
        int updateSpecWithExtra = updateSpecWithExtra(i, i10 + rect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + rect.right);
        int i11 = ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
        Rect rect2 = this.mTmpRect;
        int updateSpecWithExtra2 = updateSpecWithExtra(i6, i11 + rect2.top, ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + rect2.bottom);
        if (z9) {
