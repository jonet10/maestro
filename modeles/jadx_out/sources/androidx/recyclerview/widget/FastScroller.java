...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public void updateScrollPosition(int i, int i6) {
        ...
        boolean z9 = computeHorizontalScrollRange - i11 > 0 && i11 >= this.mScrollbarMinimumRange;
        ...
        if (z10) {
            float f = i10;
            this.mVerticalThumbCenterY = (int) ((((f / 2.0f) + i6) * f) / computeVerticalScrollRange);
            this.mVerticalThumbHeight = Math.min(i10, (i10 * i10) / computeVerticalScrollRange);
        }
        if (this.mNeedHorizontalScrollbar) {
            float f10 = i11;
            this.mHorizontalThumbCenterX = (int) ((((f10 / 2.0f) + i) * f10) / computeHorizontalScrollRange);
