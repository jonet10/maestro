...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder u7 = x.u(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            u7.append(Integer.toHexString(hashCode()));
            u7.append(" position=");
            u7.append(this.mPosition);
            u7.append(" id=");
            u7.append(this.mItemId);
            u7.append(", oldPos=");
            u7.append(this.mOldPosition);
            u7.append(", pLpos:");
            u7.append(this.mPreLayoutPosition);
    ...
    private int consumeFlingInStretch(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i6) {
        if (i > 0 && edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != 0.0f) {
            int round = Math.round(EdgeEffectCompat.onPullDistance(edgeEffect, ((-i) * FLING_DESTRETCH_FACTOR) / i6, 0.5f) * ((-i6) / FLING_DESTRETCH_FACTOR));
            if (round != i) {
                edgeEffect.finish();
            }
            return i - round;
    ...
    */
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (this.mLayout != null && !this.mLayoutSuppressed && motionEvent.getAction() == 8) {
            ...
            int i6 = (int) (r2 * this.mScaledVerticalScrollFactor);
            int i10 = (int) (f * this.mScaledHorizontalScrollFactor);
            if (z9) {
                OverScroller overScroller = this.mViewFlinger.mOverScroller;
                recyclerView = this;
    ...
    */
    ...
    public void setScrollState(int i) {
        ...
        if (sVerboseLoggingEnabled) {
            StringBuilder p10 = x.p(i, "setting scroll state to ", " from ");
            p10.append(this.mScrollState);
            Log.d(TAG, p10.toString(), new Exception());
        }
        this.mScrollState = i;
        if (i != 2) {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i6) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, androidx.recyclerview.R.styleable.RecyclerView, i, i6);
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i, @Nullable Bundle bundle) {
            ...
            if (bundle != null) {
                ...
                if (f < 0.0f) {
                    ...
                    b.o("attempting to use ACTION_ARGUMENT_SCROLL_AMOUNT_FLOAT with a negative value (", f, ")");
                    return false;
                }
            } else {
                f = 1.0f;
    ...
    public final class Recycler {
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder p10 = x.p(i, "invalid position ", ". State item count is ");
            p10.append(RecyclerView.this.mState.getItemCount());
            a.r(l.v(RecyclerView.this, p10));
            return 0;
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z9) {
            ...
            if (!z9 && (findHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i)) != null) {
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            Adapter adapter = RecyclerView.this.mAdapter;
            boolean z11 = adapter != null && doesTransientStatePreventRecycling && adapter.onFailedToRecycleView(viewHolder);
