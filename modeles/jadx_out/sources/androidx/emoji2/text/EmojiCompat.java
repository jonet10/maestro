...
public class EmojiCompat {
    ...
    public interface GlyphChecker {
        boolean hasGlyph(@NonNull CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i6, @IntRange(from = 0) int i10);
    }
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i6, @IntRange(from = 0) int i10, int i11) {
        boolean z9;
        Preconditions.checkState(isInitialized(), "Not initialized yet");
    ...
    public static class CompatInternal {
        ...
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i6, @IntRange(from = 0) int i10, boolean z9) {
            return charSequence;
        }
    }
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i6) {
        return process(charSequence, i, i6, Integer.MAX_VALUE);
    }

    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i, @IntRange(from = 0) int i6, @IntRange(from = 0) int i10) {
